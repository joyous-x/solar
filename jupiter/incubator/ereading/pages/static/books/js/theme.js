...
$(document).ready(function () {
	...
	function set_font(num){
		...
		chapter.css("cssText", "font-size: "+num+"px !important;");
		refresh_font_size();
		window.localStorage["theme-font-size"]=num;
	}
	function set_font_family(ff){
		chapter.removeClass("songti");
		chapter.removeClass("kaiti");
		chapter.removeClass("yahei");
		chapter.addClass(ff);
		 //chapter.css("cssText", "font-family: "+ff+" !important;");
		refresh_font_family();
	...
	function refresh_font_size(){
		$("#helper-font-size").text(chapter.css("font-size"));
		return parseInt(chapter.css("font-size"));
	}
	function refresh_font_family(){
		bright_font_family(content.attr("class"));
		//console.log(chapter.css("font-family"));
		return ff[chapter.css("font-family")];
	}
